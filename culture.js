...
/* 课本朱印:中小学语文教材选入此山所涉古诗(每山可一句最具代表的) */
const TEXTBOOK_BY_ROUTE = {
    10: { grade: "初中七年级", line: "会当凌绝顶,一览众山小", poet: "杜甫 ·《望岳》", version: "人教版七年级下册", note: "诵此句于课堂者,皆为东岳学生;及至岱顶,方知少年所背为何处。" },
    11: { grade: "小学一年级", line: "举头红日近,回首白云低",   poet: "寇准 ·《咏华山》", version: "人教版小学一年级上册", note: "小学课文中最早一首咏山诗。七岁背诵,五十年后登华,方解'只有天在上,更无山与齐'。" },
    12: { grade: "初中九年级", line: "衡阳雁去无留意",           poet: "范仲淹 ·《渔家傲 · 秋思》", version: "人教版九年级上册", note: "南岳衡山之北,有回雁峰——秋雁南飞至此而止。范文正词中一句,为南岳点出地理坐标。" },
    14: { grade: "初中拓展",   line: "嵩高维岳,峻极于天",       poet: "诗经 ·《大雅 · 嵩高》", version: "初中文言文拓展阅读", note: "中国最早入诗之山。少时读《诗经》不知其重,登嵩方知'峻极'二字之分量。" },
    16: { grade: "高中选修",   line: "雁荡山天下奇秀,然自古图牒未尝有言者", poet: "沈括 ·《雁荡山》(梦溪笔谈)", version: "人教版高中语文选修", note: "雁荡之名,沈存中始为之记。中学生读此节时未必去过,登灵峰方知'图牒未言'之憾。" },
    18: { grade: "初中七年级", line: "峨眉山月半轮秋,影入平羌江水流", poet: "李白 ·《峨眉山月歌》", version: "人教版七年级上册", note: "诗仙二十五岁出蜀,以此诗别故乡。课本必背,然多数人终生未至——登峨眉金顶,方知'平羌江水流'是何意。" },
    19: { grade: "初中八年级", line: "行到水穷处,坐看云起时",   poet: "王维 ·《终南别业》", version: "人教版八年级下册", note: "中学课本中境界最高一联。少年时只知是好句,登终南后方知'水穷云起'实为山林写照。本站亦以此联为卷首之引。" }
};
...
/* ============================================================
   课本山志主线 · 跟着课本去爬山
   --------------------
   按年级竖向时间轴排列。每条记录:年级 / 诗作 / 山(routeId) / 朝代 / 句 / 课本版本 / 学时按语
   未涉山诗的年级仍列出,但显示「此年级未及山诗」,以见空白处的诚意。
   ============================================================ */
const TEXTBOOK_TIMELINE = [
    { grade: "小学一年级", subjects: [
        { line: "只有天在上,更无山与齐。举头红日近,回首白云低。", poet: "寇准", dynasty: "宋", title: "咏华山", routeId: 11, version: "人教版小学一年级上册", note: "七岁的孩子背的第一首咏山诗。寇准七岁登华山所作,与诵者同龄。" }
    ]},
    { grade: "小学二年级", subjects: [] },
    { grade: "小学三年级", subjects: [] },
    { grade: "小学四年级", subjects: [] },
    { grade: "小学五年级", subjects: [] },
    { grade: "小学六年级", subjects: [] },
    { grade: "初中七年级", subjects: [
        { line: "峨眉山月半轮秋,影入平羌江水流。", poet: "李白", dynasty: "唐", title: "峨眉山月歌", routeId: 18, version: "人教版七年级上册", note: "李白二十五岁出蜀别乡之作。课本必背,然多数学子终生未至——登峨眉金顶,方知'平羌江水流'是何意。" },
            { line: "会当凌绝顶,一览众山小。", poet: "杜甫", dynasty: "唐", title: "望岳", routeId: 10, version: "人教版七年级下册", note: "少陵野老二十五岁望泰山未登而作。'会当'二字是少年志气;及壮年至岱顶,方知'凌绝顶'三字之重。" }
    ]},
    { grade: "初中八年级", subjects: [
        { line: "行到水穷处,坐看云起时。", poet: "王维", dynasty: "唐", title: "终南别业", routeId: 19, version: "人教版八年级下册", note: "中学课本中境界最高一联。少年时只知是好句,登终南后方知'水穷云起'实为山林写照。本志以此联为卷首之引。" }
    ]},
    { grade: "初中九年级", subjects: [
        { line: "塞下秋来风景异,衡阳雁去无留意。", poet: "范仲淹", dynasty: "宋", title: "渔家傲 · 秋思", routeId: 12, version: "人教版九年级上册", note: "南岳衡山北麓有回雁峰——秋雁南飞至此而返。范文正一句词,为南岳点出地理坐标。" }
    ]},
    { grade: "初中拓展", subjects: [
        { line: "嵩高维岳,峻极于天。", poet: "诗经", dynasty: "先秦", title: "大雅 · 嵩高", routeId: 14, version: "初中文言文拓展阅读", note: "中国最早入诗之山。少时读《诗经》不解其重,登嵩岳少林,方知'峻极于天'四字非虚。" }
    ]},
    { grade: "高中必修", subjects: [
        { line: "空山新雨后,天气晚来秋。", poet: "王维", dynasty: "唐", title: "山居秋暝", routeId: 19, version: "人教版高中必修", note: "摩诘晚年隐辋川,出入终南,此首与《终南别业》同作于此山。同一山,同一人,两次入卷。" }
    ]},
    { grade: "高中选修", subjects: [
        { line: "雁荡山天下奇秀,然自古图牒未尝有言者。", poet: "沈括", dynasty: "宋", title: "雁荡山(梦溪笔谈)", routeId: 16, version: "人教版高中语文选修", note: "雁荡之名,沈存中始为之记。北宋之前,典籍未载;沈括登绝顶,以一节文字使天下识雁荡。" },
            { line: "蜀道之难,难于上青天。", poet: "李白", dynasty: "唐", title: "蜀道难", routeId: 18, version: "人教版高中必修(下)", note: "诗仙写蜀道之险,峨眉为蜀中四绝之首。'连峰去天不盈尺'句,登金顶可亲见。" }
    ]}
];

function getTextbookTimeline() {
    return TEXTBOOK_TIMELINE;
}
