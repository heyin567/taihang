...
/* ============================================================
   课本山志主线 · 跟着课本去爬山(诗 · 文 · 事 三轴)
   --------------------
   按年级竖向时间轴排列。每条记录:
     kind       — 「诗」(咏山诗)/「文」(游山记)/「事」(历史事件)
     line       — 入课本之名句或事略
     title      — 出处
     poet/dynasty/protagonist  — 作者或主角与朝代
     routeId    — 所对应之入卷山
     version    — 课本版本与册次
     note       — 学时按语
...
const TEXTBOOK_TIMELINE = [
    { grade: "小学一年级", subjects: [
        { kind: "诗", line: "只有天在上,更无山与齐。举头红日近,回首白云低。", poet: "寇准", dynasty: "宋", title: "咏华山", routeId: 11, version: "人教版小学一年级上册 · 语文", note: "七岁的孩子背的第一首咏山诗。寇准七岁登华山所作,与诵者同龄。" }
    ]},
    { grade: "小学二年级", subjects: [
        { kind: "诗", line: "敕勒川,阴山下。天似穹庐,笼盖四野。天苍苍,野茫茫,风吹草低见牛羊。", poet: "北朝民歌", dynasty: "北朝", title: "敕勒歌", routeId: 24, version: "人教版二年级下册 · 语文", note: "中国课本中最早出现的山——也是唯一一首入选小学的边塞民歌。「敕勒川」即今呼和浩特至包头之间土默特平原,「阴山」即大青山。登阴山,即知「天似穹庐」非夸饰。" }
    ]},
    { grade: "小学三年级", subjects: [
        { kind: "诗", line: "天门中断楚江开,碧水东流至此回。两岸青山相对出,孤帆一片日边来。", poet: "李白", dynasty: "唐", title: "望天门山", routeId: 21, version: "人教版三年级上册 · 语文", note: "开元十三年(725)李白二十五岁出蜀东下,船至长江此段,见东西梁山如门夹江,作此诗。课本所背即此地——东梁山在江北、西梁山在江南。" },
        { kind: "诗", line: "日照香炉生紫烟,遥看瀑布挂前川。飞流直下三千尺,疑是银河落九天。", poet: "李白", dynasty: "唐", title: "望庐山瀑布", routeId: 20, version: "人教版三年级上册 · 语文", note: "诗仙写香炉峰瀑布,「银河落九天」一比千载所传。课本所背即此山,登庐山秀峰瀑布或三叠泉,「三千尺」一字不虚。" }
    ]},
    { grade: "小学四年级", subjects: [
        { kind: "诗", line: "横看成岭侧成峰,远近高低各不同。不识庐山真面目,只缘身在此山中。", poet: "苏轼", dynasty: "宋", title: "题西林壁", routeId: 20, version: "人教版四年级上册 · 语文", note: "东坡元丰七年贬汝州过庐山,题于西林寺壁。后二句已成国民共识哲句——四上每个孩子皆背,登庐山可亲见「横看成岭侧成峰」的真实地理。" },
        { kind: "诗", line: "众鸟高飞尽,孤云独去闲。相看两不厌,只有敬亭山。", poet: "李白", dynasty: "唐", title: "独坐敬亭山", routeId: 22, version: "人教版四年级下册 · 语文", note: "天宝十二载(753)李白游宣城,独坐敬亭山而作。「相看两不厌」一句道尽中国文人与山相伴之至境——四下小学必背,而此山多数人终生未访。" },
        { kind: "诗", line: "人间四月芳菲尽,山寺桃花始盛开。长恨春归无觅处,不知转入此中来。", poet: "白居易", dynasty: "唐", title: "大林寺桃花", routeId: 20, version: "部编版四年级下册 · 语文", note: "白乐天贬江州司马,登庐山大林寺,见高山桃花迟开两月而作。今花径景区即此寺旧址,墙上刻其诗,墙下小池如玉。" }
    ]},
    { grade: "小学五年级", subjects: [] },
    { grade: "小学六年级", subjects: [
        { kind: "诗", line: "红军不怕远征难,万水千山只等闲。五岭逶迤腾细浪,乌蒙磅礴走泥丸。", poet: "毛泽东", dynasty: "现代", title: "七律 · 长征", routeId: 30, version: "人教版六年级上册 · 语文", note: "1935 年 10 月红军越乌蒙、过岷山,长征将抵陕北。乌蒙山在云贵交界,绵亘千里——「磅礴走泥丸」非夸语,是俯视者之口气。课本必背一首,所写两山(乌蒙、岷山)皆入本卷。" },
        { kind: "诗", line: "金沙水拍云崖暖,大渡桥横铁索寒。更喜岷山千里雪,三军过后尽开颜。", poet: "毛泽东", dynasty: "现代", title: "七律 · 长征(下)", routeId: 31, version: "人教版六年级上册 · 语文", note: "「更喜岷山千里雪」承上联——岷山在甘川交界,雪宝顶 5588 米为长征翻越之最高山。三军过此,陕北在望,故曰「尽开颜」。一首七律,八句之中两山在卷,长征之骨自此立。" },
        { kind: "文", line: "为了不让敌人发现群众和连队主力,班长马宝玉斩钉截铁地说了一声「走!」带头向棋盘陀走去。", poet: "沈重", dynasty: "现代", title: "狼牙山五壮士", routeId: 32, version: "人教版六年级上册 · 语文", note: "1941 年 9 月晋察冀根据地反扫荡,五战士将敌引上狼牙山棋盘陀绝顶,弹尽跳崖。课文为六上必读,今莲花峰顶五壮士纪念塔与跳崖处尚在,登山所见即课文所写。" }
    ]},
    { grade: "初中七年级", subjects: [
        { kind: "诗", line: "峨眉山月半轮秋,影入平羌江水流。", poet: "李白", dynasty: "唐", title: "峨眉山月歌", routeId: 18, version: "人教版七年级上册 · 语文", note: "李白二十五岁出蜀别乡之作。课本必背,然多数学子终生未至——登峨眉金顶,方知'平羌江水流'是何意。" },
        { kind: "诗", line: "会当凌绝顶,一览众山小。", poet: "杜甫", dynasty: "唐", title: "望岳", routeId: 10, version: "人教版七年级下册 · 语文", note: "少陵野老二十五岁望泰山未登而作。'会当'二字是少年志气;及壮年至岱顶,方知'凌绝顶'三字之重。" },
        { kind: "文", line: "邑有王生,行七,故家子。少慕道,闻劳山多仙人,负笈往游。", poet: "蒲松龄", dynasty: "清", title: "劳山道士", routeId: 27, version: "人教版七年级上册 · 语文(自读)", note: "《聊斋》入选课本最广一篇。蒲留仙以崂山道士为引,讲一书生学穿墙术终招笑柄。今崂山太清宫旁有蒲松龄塑像,讽喻虽深而崂山仙气自此入民间。" },
        { kind: "事", line: "秦皇汉武,北登碣石,东巡海上,皆封禅泰山以告成功。", protagonist: "始皇帝、汉武帝", dynasty: "秦汉", title: "秦皇汉武封禅泰山", routeId: 10, version: "人教版七年级上册 · 中国历史", note: "二十四史所载封禅泰山者凡七帝,自始皇至宋真宗。课本「秦汉巩固大一统」一节专记封禅之事——封禅是国家典礼,泰山由此成为中国第一座入正史的山。" },
        { kind: "事", line: "天授改元,登封中岳;易嵩阳为登封,易阳城为告成。", protagonist: "武则天", dynasty: "唐", title: "武则天封禅嵩山", routeId: 14, version: "人教版七年级下册 · 中国历史", note: "万岁登封元年(696),武后亲登嵩岳,为中国唯一封禅中岳之帝。今河南登封县之名,即由此而立;嵩岳之尊,亦自此再厚。" },
        { kind: "事", line: "永乐征三十万军民修武当,嘉靖题「治世玄岳」石坊。", protagonist: "明成祖、明世宗", dynasty: "明", title: "永乐修武当 · 嘉靖封玄岳", routeId: 17, version: "人教版七年级下册 · 中国历史(拓展)", note: "永乐十年起兴武当宫观三十六处,有「北建故宫,南修武当」之说。嘉靖三十一年再题「治世玄岳」,武当遂凌于五岳之上——一山而得帝王二代之力,中国名山之孤例。" }
    ]},
    { grade: "初中八年级", subjects: [
        { kind: "诗", line: "行到水穷处,坐看云起时。", poet: "王维", dynasty: "唐", title: "终南别业", routeId: 19, version: "人教版八年级下册 · 语文", note: "中学课本中境界最高一联。少年时只知是好句,登终南后方知'水穷云起'实为山林写照。本志以此联为卷首之引。" }
    ]},
    { grade: "初中九年级", subjects: [
        { kind: "诗", line: "塞下秋来风景异,衡阳雁去无留意。", poet: "范仲淹", dynasty: "宋", title: "渔家傲 · 秋思", routeId: 12, version: "人教版九年级上册 · 语文", note: "南岳衡山北麓有回雁峰——秋雁南飞至此而返。范文正一句词,为南岳点出地理坐标。" },
        { kind: "诗", line: "山下旌旗在望,山头鼓角相闻。敌军围困万千重,我自岿然不动。", poet: "毛泽东", dynasty: "现代", title: "西江月 · 井冈山", routeId: 28, version: "人教版九年级上册 · 语文(自读)", note: "1928 年秋黄洋界保卫战。毛公以一连之兵,藉竹钉、滚木与一门修复迫击炮,败湘赣四团之围。「我自岿然不动」一句,成中国革命第一座山之骨——井冈山由此入卷。" },
        { kind: "诗", line: "天高云淡,望断南飞雁。不到长城非好汉,屈指行程二万。", poet: "毛泽东", dynasty: "现代", title: "清平乐 · 六盘山", routeId: 29, version: "人教版九年级上册 · 语文(自读)", note: "1935 年 10 月红军翻越六盘山,陕北在望。毛公登山而望,作此词。六盘山在宁夏南部,主峰米缸山 2942 米——长征所翻最后一座大山,「不到长城非好汉」自此成国民共记。" },
        { kind: "事", line: "1947 年 8 月,刘伯承、邓小平率晋冀鲁豫野战军强渡黄河,千里跃进大别山,揭开战略反攻序幕。", protagonist: "刘伯承、邓小平", dynasty: "现代", title: "千里跃进大别山", routeId: 33, version: "人教版八年级上册 · 中国历史", note: "解放战争由战略防御转入战略反攻之标志一役。大别山横亘鄂豫皖三省,主峰白马尖 1729 米;课本「人民解放战争」一节专记此事——大别山由此与井冈山并立为「中国革命双圣山」。" }
    ]},
    { grade: "初中拓展", subjects: [
        { kind: "诗", line: "嵩高维岳,峻极于天。", poet: "诗经", dynasty: "先秦", title: "大雅 · 嵩高", routeId: 14, version: "初中文言文拓展阅读", note: "中国最早入诗之山。少时读《诗经》不解其重,登嵩岳少林,方知'峻极于天'四字非虚。" },
        { kind: "文", line: "孔子登东山而小鲁,登泰山而小天下。故观于海者难为水,游于圣人之门者难为言。", poet: "孟子", dynasty: "战国", title: "孟子 · 尽心上", routeId: 10, version: "初中文言文拓展阅读 · 语文", note: "中学课本《得道多助》《生于忧患》皆出《孟子》;此句为先秦诸子最早咏泰山者——「凌绝顶」与「小天下」二者,千载以来皆泰山专享。" }
    ]},
    { grade: "高中必修", subjects: [
        { kind: "诗", line: "天姥连天向天横,势拔五岳掩赤城。安能摧眉折腰事权贵,使我不得开心颜。", poet: "李白", dynasty: "唐", title: "梦游天姥吟留别", routeId: 23, version: "人教版高中必修(上) · 语文", note: "天宝四载(745)李白将离东鲁南下越中,作此诗赠别。「安能摧眉折腰事权贵」一句为千古之骨。然天姥山实在浙东新昌,海拔不过八百米——「势拔五岳」乃诗仙梦境之夸饰,惟登之方知,非真高,实是李白心中之高。" },
        { kind: "诗", line: "空山新雨后,天气晚来秋。", poet: "王维", dynasty: "唐", title: "山居秋暝", routeId: 19, version: "人教版高中必修(上) · 语文", note: "摩诘晚年隐辋川,出入终南,此首与《终南别业》同作于此山。同一山,同一人,两次入卷。" },
        { kind: "文", line: "苍山负雪,明烛天南。望晚日照城郭,汶水、徂徕如画,而半山居雾若带然。", poet: "姚鼐", dynasty: "清", title: "登泰山记", routeId: 10, version: "人教版高中必修(上) · 语文", note: "桐城派姚姬传乾隆三十九年除夕登岱顶看日出之记。半山雾气如带一段,中国山水散文至文之一。课本读毕,登日观峰当再读一遍。" },
        { kind: "文", line: "夫夷以近,则游者众;险以远,则至者少。尽吾志也而不能至者,可以无悔矣。", poet: "王安石", dynasty: "宋", title: "游褒禅山记", routeId: 25, version: "人教版高中必修(下) · 语文", note: "至和元年(1054)介甫与友游褒禅山,入华阳后洞至最深处,因怠而出,出后悔不能尽兴。归后作记,以登山未尽喻治学未深——「尽吾志而无悔」一句,中国议论文之骨。课本读毕,登前后洞、辨仆道残碑「花山」二字,游与记始合。" },
        { kind: "文", line: "事不目见耳闻,而臆断其有无,可乎?舟回至两山间,将入港口。", poet: "苏轼", dynasty: "宋", title: "石钟山记", routeId: 26, version: "人教版高中必修(下) · 语文", note: "元丰七年(1084)东坡送子苏迈赴德兴,夜泛舟至石钟山下,亲探水石相搏之声以辨郦道元、李渤之说。中国实证文之骨,与《游褒禅山记》议论山记并峙。今下钟山临鄱阳湖口,夜静仍可听水石相搏。" }
    ]},
    { grade: "高中选修", subjects: [
        { kind: "文", line: "雁荡山天下奇秀,然自古图牒未尝有言者。", poet: "沈括", dynasty: "宋", title: "雁荡山(梦溪笔谈)", routeId: 16, version: "人教版高中语文选修", note: "雁荡之名,沈存中始为之记。北宋之前,典籍未载;沈括登绝顶,以一节文字使天下识雁荡。" },
            { kind: "诗", line: "蜀道之难,难于上青天。", poet: "李白", dynasty: "唐", title: "蜀道难", routeId: 18, version: "人教版高中必修(下) · 语文", note: "诗仙写蜀道之险,峨眉为蜀中四绝之首。'连峰去天不盈尺'句,登金顶可亲见。" }
    ]}
];
